...
int main() {
  bool passed = true;
  passed &= testVectors<int8_t, 2>("int8_t");
  passed &= testVectors<int16_t, 2>("int16_t");
  passed &= testVectors<int32_t, 2>("int32_t");
  passed &= testVectors<int64_t, 2>("int64_t");
  passed &= testVectors<uint8_t, 2>("uint8_t");
  passed &= testVectors<uint16_t, 2>("uint16_t");
  passed &= testVectors<uint32_t, 2>("uint32_t");
  passed &= testVectors<uint64_t, 2>("uint64_t");
  passed &= testVectors<float, 2>("float");
  passed &= testVectors<double, 2>("double");

  passed &= testVectors<int8_t, 3>("int8_t");
  passed &= testVectors<int16_t, 3>("int16_t");
  passed &= testVectors<int32_t, 3>("int32_t");
  passed &= testVectors<int64_t, 3>("int64_t");
  passed &= testVectors<uint8_t, 3>("uint8_t");
  passed &= testVectors<uint16_t, 3>("uint16_t");
  passed &= testVectors<uint32_t, 3>("uint32_t");
  passed &= testVectors<uint64_t, 3>("uint64_t");
  passed &= testVectors<float, 3>("float");
  passed &= testVectors<double, 3>("double");

  passed &= testVectors<int8_t, 4>("int8_t");
  passed &= testVectors<int16_t, 4>("int16_t");
  passed &= testVectors<int32_t, 4>("int32_t");
  passed &= testVectors<int64_t, 4>("int64_t");
  passed &= testVectors<uint8_t, 4>("uint8_t");
  passed &= testVectors<uint16_t, 4>("uint16_t");
  passed &= testVectors<uint32_t, 4>("uint32_t");
  passed &= testVectors<uint64_t, 4>("uint64_t");
  passed &= testVectors<float, 4>("float");
  passed &= testVectors<double, 4>("double");
